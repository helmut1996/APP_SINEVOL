...
public class utilidadesFact {
    ...
    public static final  String CREAR_TABLA_RECIBO= "CREATE TABLE "+TABLA_RECIBO+"("+CAMPO_NOMBRE_CLIEBTE+" TEXT ,"+CAMPO_FACTURA+" TEXT, "+CAMPO_FECHA+" TEXT, "+CAMPO_ABONO+" REAL, "+CAMPO_DESCUENTO+" REAL, "+CAMPO_SALDO_RES+" REAL,"+CAMPO_NUMERO_RESF+" INTEGER)";
}
